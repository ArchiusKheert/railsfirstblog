...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { birth_date: @star.birth_date, country: @star.country, first_name: @star.first_name, last_name: @star.last_name, team: @star.team } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { birth_date: @star.birth_date, country: @star.country, first_name: @star.first_name, last_name: @star.last_name, team: @star.team } }
